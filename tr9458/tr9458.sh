...
${GXDIMAGELOAD}/tr9458fullsize.py >> ${LOG}
if [ $? -ne 0 ]
then
    echo 'tr9458fullsize.py failed' >> ${LOG}
    exit 1
fi
...
${GXDIMAGELOAD}/tr9458thumbnail.py >> ${LOG}
if [ $? -ne 0 ]
then
    echo 'tr9458thumbnail.py failed' >> ${LOG}
    exit 1
fi
...
#${ASSAYLOAD}/tr9458insitu.py >> ${LOG}
#if [ $? -ne 0 ]
#then
#    echo 'tr9458insitu.py failed' >> ${LOG}
#    exit 1
#fi
