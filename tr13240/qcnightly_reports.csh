...
foreach i (GXD_NotInCache.sql GXD_SpecNoAge.sql GXD_SpecTheiler.sql GXD_FullCodeMissingIndex.sql)
...
foreach i (GXD_SpecTheilerAge.py GXD_SameStructure.py GXD_ImagesUnused.py)
    echo `date`: $i | tee -a ${LOG}
