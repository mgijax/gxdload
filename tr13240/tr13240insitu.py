...
#
# Program: tr13240insitu.py
#
# Original Author: Lori Corbani
#
# Purpose:
#
#	To translate 13240/LoaderFiles/InSitu files into input files for the insituload.py program.
#
...
#
#       InSituAssays.txt, a tab-delimited file in the format:
#
...
inAssayFileName = os.environ['PROJECTDIR'] + '/InSituAssays.txt'
inSpecimenFileName = os.environ['PROJECTDIR'] + '/InSituSpecimens.txt'
inResultFileName = os.environ['PROJECTDIR'] + '/InSituResults.txt'
...
#	imageLookup[key].append(r['_ImagePane_key'])
    ...
    for line in inAssayFile.readlines():
        ...
        if markerID not in assayLookup:
