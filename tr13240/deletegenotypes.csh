...
--
select g._Genotype_key, a.accID, substring(s.strain, 1, 65) as strain
...
and not exists (select 1 from VOC_Annot a where g._Genotype_key = a._Object_key and a._AnnotType_key in (1001,1002,1005,1020))
